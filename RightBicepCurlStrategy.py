...
class RightBicepCurlStrategy(IExerciseAnalysisStrategy):
    ...
    def __init__(self, landmarks):
        ...
        self.r_shoulder_angle = AngleCalculator.calculate_angle_from_landmarks(landmarks,
                                                                            self.mp_pose.RIGHT_ELBOW,
                                                                            self.mp_pose.RIGHT_SHOULDER,
    ...
    def is_correct(self):
        ...
        if 20 < self.r_elbow_angle < 60 and 10 < self.r_shoulder_angle < 20 and 0.1 >= self.r_shoulder_wrist > 0 :
